...
//        cout << "Stimulus " << stimulus << "; imin: " << imin << "; jmin: " << jmin << "; kmin: " << kmin << endl;
		...
		for (i=imin;i<=imax;i++)
		{
			...
			// MSCs_to_prol=int(MSCs*0.04);							// from Tourolle et al. 2011
			// fibroblasts_to_prol=int(fibroblasts*0.0336);			// interpolated using power law 
			// chondrocytes_to_prol=int(chondrocytes*0.00444);			// 	extrapolated using power law 
			// mature_osteoblasts_to_prol=int(mature_osteoblasts*0.01);// from Tourolle et al. 2011
    ...
    ofstream myfile;
	myfile.open("output\\proliferation.txt", ios::app); // in following order: MSCs, osteoblasts, chondrocytes, fibroblasts
