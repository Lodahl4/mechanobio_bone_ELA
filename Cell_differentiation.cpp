	...
	int element_local_min[NUMBER_ELEMS][3],int element_local_max[NUMBER_ELEMS][3],int lattice_point_element[LATTICE_X][LATTICE_Y][LATTICE_Z],int iter)
{
    ...
    *************************************************************/
    ...
    int mature_osteoblasts,chondrocytes,fibroblasts;//inmature_osteoblasts;
	...
	int total_chondro_apop, total_fibro_apop, total_osteo_apop; // to store total apoptosis counts
	total_chondro_apop=total_fibro_apop=total_osteo_apop=0;
    ...
    // const float apoptosis_rate_osteoblasts=0.01;        // from Tourolle et al. 2011
    // const float apoptosis_rate_chondrocytes=6.8E-5;     // from Tourolle et al. 2011
    // const float apoptosis_rate_fibroblasts=3.4E-8;      // extrapolated using power law 
    ...
    for (elem=0;elem<NUMBER_ELEMS;elem++)
    {
        ...
        cells_to_differentiate = int(cells_to_differentiate * 0.06); // 6% of MSCs differentiate each iteration (alternatively 30%)
        ...
        **********************************************************************************************************/
        if (stimulus_dif[elem]==5)
        {
			...
			total_chondro_apop+=chondrocytes_removed;
        ...
        **********************************************************************************************************/
        ...
        if (stimulus_dif[elem]==4)
        {
			...
			total_fibro_apop+=fibroblasts_removed;
        ...
        **********************************************************************************************************/        
        if (stimulus_dif[elem]==1)
        {
			...
			total_fibro_apop+=fibroblasts_removed;
			total_chondro_apop+=chondrocytes_removed;
			total_osteo_apop+=mature_osteoblasts_removed;
    ...
    ofstream myfile;
	myfile.open("output\\differentiation.txt", ios::app); // total number of MSCs, how many should differentiation, then differentiation in following order: osteoblasts, chondrocytes, fibroblasts
	myfile << MSCs << " " << to_diff << " " << osteo_diff << " " << chondro_diff << " " << fibro_diff << endl;
	myfile.close();
	
	// Write apoptosis info to a file
	ofstream apoptosis_file;
	apoptosis_file.open("output\\apoptosis.txt", ios::app); // apoptosis counts in following order: osteoblasts, chondrocytes, fibroblasts
	apoptosis_file << total_osteo_apop << " " << total_chondro_apop << " " << total_fibro_apop << endl;
	apoptosis_file.close();
} 
